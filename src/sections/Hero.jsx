  ...
  return (
    <section className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
        <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
            ...
            <h1 className="text-8xl font-bold mt-10 max-sm:text-[72px] max-sm:leading-[82] font-palanquin ">
                <span className="xl:bg-white xl:whitespace-nowrap absolute z-10 pr-10 ">The New Arrival </span>
                <br />
                <span className="text-coral-red inline-block mt-3">Nike</span> Shoes
            </h1>
            <p className="font-montserrat text-lg mt-6 mb-14 text-slate-gray sm:max-w-sm leading-8 ">Discover stylish Nike arrivals, quality comfort ,and innovation for your active life.</p>
